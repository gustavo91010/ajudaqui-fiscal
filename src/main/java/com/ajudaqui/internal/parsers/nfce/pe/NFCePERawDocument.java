...
public class NFCePERawDocument implements RawFiscalDocument {
    ...
    public NFCePERawDocument(Map<String, String> rawData, List<Map<String, String>> items, List<Map<String, String>> payments) {
