...
public class NFCePRNormalizer implements Normalizer<NFCePRRawDocument> {
    
    @Override
    public FiscalDocument normalize(NFCePRRawDocument raw) {
    ...
    private String translatePaymentMethod(String code) {
        ...
        switch (code) {
            ...
            case "05": return "CREDITO_LOJA";
            case "10": return "VALE_ALIMENTACAO";
            case "11": return "VALE_REFEICAO";
            case "12": return "VALE_PRESENTE";
            case "13": return "VALE_COMBUSTIVEL";
            case "15": return "BOLETO_BANCARIO";
            case "17": return "PIX";
            case "90": return "SEM_PAGAMENTO";
            case "99": return "OUTROS";
            default: return "OUTROS (" + code + ")";
        }
    }
